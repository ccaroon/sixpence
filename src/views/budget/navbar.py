...
class BudgetNavBar(ft.AppBar):
            ...
            actions=[
                ...
                ft.SegmentedButton(
                    ...
                    segments=[
                        ...
                        ft.Segment(
                            icon=ft.Icon(ft.Icons.CALENDAR_MONTH, color=ft.Colors.ON_PRIMARY_CONTAINER),
                            value=12,
                        ),
                        ft.Segment(
                            icon=ft.Icon(ft.Icons.ALL_INCLUSIVE, color=ft.Colors.ON_PRIMARY_CONTAINER),
                            value="all",
                        ),
                    ],
                ),
    ...
    def __on_search_submit(self, evt):
        ...
        self.__refresh(reset_filters=True, **filters)
